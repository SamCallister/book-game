  ...
  return (
    <div className={s.content}>
        ...
        <div className={s.cardContainer}>
          <Card variant="outlined" className={s.cardOverride}>
            <div className={s.gameOverTextContainer}>
              ...
              <div className={s.numCorrectText}>
                You got {numCorrect} of {numQuestions} correct.
              </div>
              <div className={s.gameOverButtonsContainer}>
                ...
                <div
                  className={`${s.selectAnotherQuizText} ${s.selectAnotherByButton}`}
                >
      ...
      <div className={showQuestions ? "" : s.hide}>
        ...
        <div
          className={`${s.anotherQuizBottomContainer} ${s.selectAnotherQuizText}`}
        >
          <Link to={gameSelectUrl}>Select another quiz</Link>
        </div>
      </div>
